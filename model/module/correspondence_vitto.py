...
from model.util.loss_utils_vitto import divide_by_frame, divide_by_instance
...
class Correspondence:
    ...
    def match(self, img_feat, mesh_feat, mask, pred_v):
        ...
        # The cosine distance is equivalent to the dot product of normalized features. We normalized the features once we computed them in the encoder, 
        # then pointcorr = mesh_feat.bmm(img_feat), we complete this dot product. The exponentiation is in the torch.softmax() function.
